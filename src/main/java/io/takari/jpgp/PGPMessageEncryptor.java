...
import io.takari.jpgp.internal.BasePGPCommon;
import io.takari.jpgp.internal.io.IOUtils;
 ...
 * @author iulius
 */
public class PGPMessageEncryptor extends BasePGPCommon {
  ...
  private void encryptAndSign(PGPSecretKey pgpSecretKey, String password, String inputDataName, InputStream inputData, OutputStream encryptedDataStream) throws PGPException, IOException {
    ...
    LOGGER.trace("Secret Key: {}, Password: {}, Input Name: {}, Input Data: {}, Output Data: {}", pgpSecretKey == null ? "not set" : "set", password == null ? "not set" : "********", inputDataName,
      inputData == null ? "not set" : "set", encryptedDataStream == null ? "not set" : "set");
  ...
  public boolean encrypt(InputStream publicKeyOfRecipient, String inputDataName, InputStream plainInputData, OutputStream target) {
    ...
    LOGGER.trace("Public Key: {}, Input Name: {}, Input Data: {}, Output: {}", publicKeyOfRecipient == null ? "not set" : "set", inputDataName, plainInputData == null ? "not set" : "set",
      target == null ? "not set" : "set");
  ...
  public boolean encrypt(InputStream publicKeyOfRecipient, InputStream privateKeyOfSender, String userIdOfSender, String passwordOfSendersPrivateKey, String inputDataName, InputStream plainInputData,
    ...
    LOGGER.trace("Public Key: {}, Private Key: {}, User ID: {}, Password: {}, Input Name: {}, Input Data: {}, Output: {}",
      publicKeyOfRecipient == null ? "not set" : "set", privateKeyOfSender == null ? "not set" : "set", userIdOfSender, passwordOfSendersPrivateKey == null ? "not set" : "********", inputDataName,
      plainInputData == null ? "not set" : "set", target == null ? "not set" : "set");
    boolean result = true;
